    ...
    <div class="container" style="margin-top:50px">
        ...
        <form class="form-horizontal" action="addNewCustomer.php" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="name" class="form-control" id="name" placeholder="Enter fullname here.." name="name">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-2" for="name">Phone number:</label>
                <div class="col-sm-10">
                    <input type="phno" class="form-control" id="phno" placeholder="Enter phone number here.." name="phno">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="state" class="form-control" id="state" placeholder="Enter state here.." name="state" maxlength="2">
                </div>
            </div>
