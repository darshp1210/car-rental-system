...
<body style="background-color:#ADD8E6"style="height:1500px">
    ...
    <div class="container" style="margin-top:50px">
        <div style="display:flex; align-items:center;">
            <h2 style="margin-right:50%;">Our happy customers:</h2>
            <button style="background-color:#FF8C00" type="button" class="btn btn-success"onclick="window.location='customer.php'"> Add new Customer </button>
        </div>
        <table id="myTable">
                    <tr class="header">
